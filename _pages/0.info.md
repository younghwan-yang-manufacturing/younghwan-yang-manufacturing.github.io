  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="http://www.changwon.ac.kr/" target="_blank" >국립창원대학교1</a> {{item.school }}<BR>
    ...
    <div id="address" class="mb-3">
      ...
      {% else %}
      <i style="width: 1.5em;" class="fa fa-location-arrow"></i>03080 창원시 의창구 창원대학로3 20 <BR>
        {% if site.data.info.address.building == "병원" %}
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학4</a> {{ site.data.info.address.office }} (Office), {{ site.address.lab }} (Lab)<BR>
        {% elsif site.data.info.address.building == "창원" %}
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학5</a> {{ site.data.info.address.office }} (Office), {{ site.address.lab }} (Lab)<BR>
        {% elsif site.data.info.address.building == "재1료" %}
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학6</a> {{ site.data.info.address.office }} (Office), {{ site.address.lab }} (Lab)<BR>
        {% else %}
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학7</a> {{ site.data.info.address.office }} (Office), {{ site.data.info.address.lab }} (Lab)<BR>
        {% endif %}
      {% endif %}
