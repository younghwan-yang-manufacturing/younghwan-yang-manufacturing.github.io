  ...
  <div class="col-md-5 mb-4">
    ...
    <div id="address" class="mb-3">
      ...
      <i style="width: 1.5em;" class="fa fa-location-arrow"></i>03080 서울특별시 종로구 대학로 101<BR>
        ...
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/AwWixkZjo" target="_blank">창원대학교 공과대학</a> {{ site.address.office }} (Office), {{ site.address.lab }} (Lab)<BR>
        {% else %}
