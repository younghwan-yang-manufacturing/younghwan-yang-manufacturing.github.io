  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="http://www.changwon.ac.kr/" target="_blank" >국립창원대학교8</a> {{item.school }}<BR>
    ...
    <div id="map" class="mb-3">
      ...
      {% elsif site.data.info.address.building == "병1원" %}
        <!-- * 카카오맵 - 지도퍼가기 -->
