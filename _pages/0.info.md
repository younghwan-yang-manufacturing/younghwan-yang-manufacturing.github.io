  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="http://www.changwon.ac.kr/" target="_blank" >국립창원대학교2</a> {{item.school }}<BR>
    ...
    <div id="map" class="mb-3">
      ...
      {% elsif site.data.info.address.building == "병원" %}
        <!-- * 카카오맵 - 지도퍼가기 -->
        <div id="daumRoughmapContainer1749797956152" class="root_daum_roughmap root_daum_roughmap_landing shadow-dark mx-auto"></div>
        <script charset="UTF-8">
          new daum.roughmap.Lander({
        		"timestamp" : "1749797956152",
        		"key" : "3h2gjowka3v",
            "mapWidth" : currentMapWidth,
            "mapHeight" : "200"
          }).render();
