  ...
  <div class="col-md-5 mb-4">
    ...
    <div id="address" class="mb-3">
      ...
      <i style="width: 1.5em;" class="fa fa-location-arrow"></i>03080 창원시 의창구 창원대학로 20 <BR>
        ...
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학</a> {{ site.data.info.address.office }} (Office), {{ site.address.lab }} (Lab)<BR>
        {% else %}
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/KM72_rhfdZ" target="_blank">창원대학교 공과대학</a> {{ site.data.info.address.office }} (Office), {{ site.data.info.address.lab }} (Lab)<BR>
        {% endif %}
      {% endif %}
