  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="http://www.changwon.ac.kr/" target="_blank" >국립창원대학교6</a> {{item.school }}<BR>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=당신의_APP_KEY"></script>
<script>
  var container = document.getElementById('map');
  var options = {
    center: new kakao.maps.LatLng(35.2446, 128.6956), // 창원대 위도, 경도
    level: 3
  };
  ...
  // 마커 표시
  var markerPosition = new kakao.maps.LatLng(35.2446, 128.6956);
